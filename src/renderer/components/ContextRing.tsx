  ...
  return (
    <div className="relative flex shrink-0 items-center gap-1.5" ref={ref}>
      ...
      <div
        ...
        style={compact ? { width: 16, height: 16 } : { width: SIZE, height: SIZE, boxShadow: '0 4px 12px rgba(0,0,0,0.3)' }}
        onClick={toggle}
        title="Context usage"
      >
        <svg
          width={compact ? 16 : SIZE}
          height={compact ? 16 : SIZE}
          viewBox={`0 0 ${SIZE} ${SIZE}`}
          style={{ transform: 'rotate(-90deg)' }}
        >
          <circle cx={SIZE / 2} cy={SIZE / 2} r={RADIUS} fill="none" stroke="var(--bg-surface-container-high)" strokeWidth={compact ? 4 : STROKE} />
          <circle
            cx={SIZE / 2} cy={SIZE / 2} r={RADIUS} fill="none"
            stroke={ringColor} strokeWidth={compact ? 4 : STROKE}
