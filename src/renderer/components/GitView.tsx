        ...
        <div className="shrink-0" style={{ padding: '8px 6px 8px', borderTop: `1.5px solid ${GIT.cardBorder}` }}>
          <div style={{
            ...
            <button onClick={doCommit} disabled={!msg.trim() || loading}
              className="shrink-0 flex items-center justify-center transition-all duration-100 disabled:opacity-30 hover:brightness-110 active:scale-95 cursor-pointer"
              style={{ background: 'none', border: 'none', padding: 4, color: 'var(--text-on-surface-variant)' }}
